...
function initUsers() {
    ...
    var deleteButtons = document.querySelectorAll('button[name="delete-user-btn"]');
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch("/user/delete/".concat(e.id), {
                                method: "POST",
                            })];
                    case 1:
                        response = _a.sent();
